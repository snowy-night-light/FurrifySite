...
* Generated Angular service for BookV1RestController controller
...
import { Pageable, RequestOptions, PagedModelBookDTO, CreateBookRequest, BookDTO, PatchBookRequest } from "../models";
import { PagedRestService } from "../../../base/paged-rest-service.interface";

@Injectable({ providedIn: "root" })
export class BookV1RestControllerService implements PagedRestService<BookDTO, CreateBookRequest, PatchBookRequest> {
    ...
    getAllPaged(pageable: Pageable, spec?: string, observe?: 'body', options?: RequestOptions<'json'>): Observable<PagedModelBookDTO>;
    getAllPaged(pageable: Pageable, spec?: string, observe?: 'response', options?: RequestOptions<'json'>): Observable<HttpResponse<PagedModelBookDTO>>;
    getAllPaged(pageable: Pageable, spec?: string, observe?: 'events', options?: RequestOptions<'json'>): Observable<HttpEvent<PagedModelBookDTO>>;
    ...
    getById(id: string, observe?: 'body', options?: RequestOptions<'json'>): Observable<BookDTO>;
    getById(id: string, observe?: 'response', options?: RequestOptions<'json'>): Observable<HttpResponse<BookDTO>>;
    getById(id: string, observe?: 'events', options?: RequestOptions<'json'>): Observable<HttpEvent<BookDTO>>;
