...
* Generated Base Interceptor for client Attachments
* Do not edit this file manually
*/
import { HttpContextToken, HttpEvent, HttpHandler, HttpInterceptor, HttpRequest } from "@angular/common/http";
import { inject, Injectable } from "@angular/core";
import { Observable } from "rxjs";
import { CLIENT_CONTEXT_TOKEN_ATTACHMENTS, HTTP_INTERCEPTORS_ATTACHMENTS } from "../tokens";

@Injectable()
export class AttachmentsBaseInterceptor implements HttpInterceptor {
    private readonly httpInterceptors: HttpInterceptor[] = inject(HTTP_INTERCEPTORS_ATTACHMENTS);
